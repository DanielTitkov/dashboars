...
// Returns a *NotSingularError when exactly one TaskTag entity is not found.
...
// Returns a *NotSingularError when exactly one TaskTag ID is not found.
...
func (ttq *TaskTagQuery) sqlAll(ctx context.Context) ([]*TaskTag, error) {
	...
	if query := ttq.withTasks; query != nil {
		...
		ids := make(map[int]*TaskTag, len(nodes))
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(tasktag.TasksPrimaryKey[0], fks...))
			},
